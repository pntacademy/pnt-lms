  ...
  return (
    <div className="min-h-full font-sans text-slate-800 p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <button className="flex flex-col items-center justify-center gap-2 p-6 bg-gradient-to-br from-orange-300 to-amber-400 border border-slate-200 rounded-xl shadow-sm hover:shadow-md hover:-translate-y-1 hover:shadow-xl active:translate-y-1  transition-all">
            ...
            <tbody>
              {[1, 2, 3].map((item) => (
                <tr key={item} className="border-b-2 border-slate-100 hover:bg-slate-50 transition-colors">
                  ...
                  <td className="p-4">
                    <button className="px-4 py-2 bg-black text-white text-xs font-black uppercase border border-slate-200 rounded hover:bg-gradient-to-br from-orange-300 to-amber-400 hover:text-slate-800 transition-colors">
                      Review File
                    </button>
                  </td>
                </tr>
