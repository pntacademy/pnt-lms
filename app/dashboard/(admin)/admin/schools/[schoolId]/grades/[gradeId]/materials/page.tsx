...
import { ArrowLeft, BookOpen, Video, FileText, Link as LinkIcon, Calendar } from "lucide-react";
import Link from "next/link";
import { CreateMaterialForm } from "./CreateMaterialForm";
import { DeleteMaterialButton } from "./DeleteMaterialButton";

export default async function GradeMaterialsPage({ params }: { params: Promise<{ schoolId: string; gradeId: string }> }) {
