        ...
        >
          ...
          >
            <div className="p-6 md:p-8">
              ...
              <h3 className="text-xl font-black text-slate-900 mb-3 tracking-tight">Delete Material?</h3>
              <p className="text-slate-500 text-sm leading-relaxed mb-8 font-medium">
                Are you sure you want to completely delete this material? This action cannot be undone.
              </p>
