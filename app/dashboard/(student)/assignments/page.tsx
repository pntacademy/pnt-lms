...
export default function AssignmentsPage() {
  ...
  return (
    <div className="min-h-full font-sans text-slate-800 p-4 md:p-8 max-w-6xl mx-auto space-y-8">
      ...
      {/* Upload Form */}
      <Card className="pt-0 gap-0 border-0 ring-0 rounded-xl shadow-xl shadow-slate-200/50 bg-white">
        <CardHeader className="bg-gradient-to-br from-orange-300 to-amber-400 border-b-0 pt-4 pb-3">
